...
import { kiteEqualAngles as puzzle } from "../puzzles/kite_equal_angles";

/**
 * Drop-policy verification for the shipped `kite_equal_angles` puzzle: every
 ...
 */
describe("kite_equal_angles (shipped puzzle)", () => {
