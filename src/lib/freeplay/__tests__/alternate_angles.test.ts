...
import { alternateAngles as puzzle } from "../puzzles/alternate_angles";

/**
 * Drop-policy verification for the shipped `alternate-angles` puzzle: every given
 * and the goal must hold numerically, and the full solution chain must replay in
 * the SHIPPED verifier (DD/AR + promoted rules), ending at the goal.
 */
describe("alternate-angles (shipped puzzle)", () => {
