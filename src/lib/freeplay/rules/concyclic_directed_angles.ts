/**
 * Concyclic from equal DIRECTED angles (promoted from research/freeplay-rules).
 *
 ...
 * proves the angle identity yet can never EMIT the circle. (This is the missing
 * move that finishes the IMO 2019 P2 chain: the auxiliary circles C,Q1,B2,A2 and
 * C,P1,B2,A2 and the final P,P1,Q,Q1 are all opposite-side configurations.)
 *
 ...
 *   `AngleAR.implies` is symbolic (coordinates fix only signs/branches, never
