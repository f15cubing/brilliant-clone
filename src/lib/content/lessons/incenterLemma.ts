...
function angleWithBisector() {
  return [
    ...
    point("S2", -4, 2.4),
    {
      ...
      attributes: { strokeColor: "#334155", strokeWidth: 2 },
    },
    {
      id: "lineVS2",
      type: "line",
...
function internalExternalAtB() {
  return [
    ...
    point("B", -2.2, -2.8),
    point("C", 4.2, -1.2),
    segment("B", "A", { strokeColor: "#334155" }),
    segment("B", "C", { strokeColor: "#334155" }),
    {
      id: "Cp",
      type: "point",
      parents: [
    ...
    segment("B", "Cp", { strokeColor: "#94a3b8", dash: 2, strokeWidth: 1.5 }),
    {
      id: "Pi",
      type: "point",
      parents: [
  ...
  problems: [
    ...
    },
    {
      ...
      boardConfig: {
        ...
        elements: [
          ...
          segment("B", "C", { strokeColor: "#334155", strokeWidth: 1.5 }),
    ...
    },
    {
      ...
      boardConfig: {
        ...
        elements: [
          ...withCircumAndL(),
          segment("I", "B", { strokeColor: "#334155", strokeWidth: 1.5 }),
