...
const SYSTEM_PROMPT = [
  ...
  "  the angle vertices.",
  "- similar: 6 points [A,B,C,D,E,F] meaning △ABC ~ △DEF (the two triangles are",
  "  similar), with correspondence A↔D, B↔E, C↔F in the LISTED order. Use this",
  "  when the learner STATES a similarity; the corresponding proportional sides",
  "  are then a separate `eqratio` step.",
...
const FEW_SHOTS = [
  ...
  "   }",
  "",
  "5) Stating a similarity (AA). Two equal angles ⇒ the triangles are similar.",
  "   Figure points A,B,C,D,E,F.",
  "   Statement: \"Since ∠BAC = ∠EDF and ∠ABC = ∠DEF, triangles ABC and DEF are",
  "   similar.\"",
  "   Output: {",
  "     \"conclusion\": {\"kind\":\"rel\",\"name\":\"similar\",\"points\":[\"A\",\"B\",\"C\",\"D\",\"E\",\"F\"]},",
  "     \"premises\": [",
  "       {\"kind\":\"rel\",\"name\":\"eqangle\",\"points\":[\"B\",\"A\",\"C\",\"E\",\"D\",\"F\"],\"source\":\"∠BAC = ∠EDF\"},",
  "       {\"kind\":\"rel\",\"name\":\"eqangle\",\"points\":[\"A\",\"B\",\"C\",\"D\",\"E\",\"F\"],\"source\":\"∠ABC = ∠DEF\"}",
  "     ]",
  "   }",
].join("\n");
